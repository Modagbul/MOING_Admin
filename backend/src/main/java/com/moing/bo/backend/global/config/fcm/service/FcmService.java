package com.moing.bo.backend.global.config.fcm.service;

import com.google.firebase.messaging.*;
import com.moing.bo.backend.domain.history.application.mapper.AlarmHistoryMapper;
import com.moing.bo.backend.domain.history.application.service.SaveMultiAlarmHistoryUseCase;
import com.moing.bo.backend.domain.history.application.service.SaveSingleAlarmHistoryUseCase;
import com.moing.bo.backend.global.config.fcm.dto.request.MultiRequest;
import com.moing.bo.backend.global.config.fcm.dto.request.SingleRequest;
import com.moing.bo.backend.global.config.fcm.dto.response.MultiResponse;
import com.moing.bo.backend.global.config.fcm.dto.response.SingleResponse;
import com.moing.bo.backend.global.config.fcm.exception.NotificationException;
